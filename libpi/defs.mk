...
ifndef SPEAKER_BOOTLOADER_PATH
$(error SPEAKER_BOOTLOADER_PATH is not set: this should contain the absolute path to where this directory is.  Define it in your shell's initialiation.  For example, .tcshrc for tcsh or .bashrc for bash)
endif
...
OD  = $(ARM)-objdump
OCP = $(ARM)-objcopy
CS240LX_2026_LIBPI_PATH = $(SPEAKER_BOOTLOADER_PATH)/libpi
LPP = $(CS240LX_2026_LIBPI_PATH)
LPI ?= $(LPP)/libpi.a
LGCC ?= $(SPEAKER_BOOTLOADER_PATH)/lib/libgcc.a
...
LIBM_DIR ?=  $(SPEAKER_BOOTLOADER_PATH)/lib/libm/
